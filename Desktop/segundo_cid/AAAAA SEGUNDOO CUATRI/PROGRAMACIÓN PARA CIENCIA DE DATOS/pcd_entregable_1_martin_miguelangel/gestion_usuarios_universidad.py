...
u.añadir_asociado(
    ...
    "C/Plaza",
    54321,
    [plantas, neurología, bioinformatica],
    Departamento.DIS,
)
u.añadir_asociado(
    "Elena",
...
u.añadir_estudiante("Ana", "12345678A", Sexo.M, "C/Calle", 12345, [bases_datos, pcd])
u.añadir_estudiante(
    "Carlos",
    "87654321B",
    Sexo.V,
...
u.añadir_estudiante(
    "Elena", "11111111C", Sexo.M, "C/Avenida", 67890, [microbiología, neurología]
)
u.añadir_estudiante(
    "Elena", "11111111C", Sexo.M, "C/Avenida", 67890, [microbiología, neurología]
)
